...
namespace Oxide.Game.Rust
{
    ...
    public partial class RustCore
    {
        ...
        private object OnEntityReskin(BaseEntity entity, ulong skinId, BasePlayer player)
        {
            ...
            Interface.Oxide.LogDebug($"OnEntityReskin test ... {skin.id} {skin.name} {skin.itemid} {skin.isSkin}");
            Interface.Oxide.LogDebug($"OnEntityReskin test2 ... {skinId}");
            Interface.Oxide.LogDebug($"---------------------------------------------------------------------------------------");
        ...
        private void OnEntityReskinned(BaseEntity entity, ulong skinId, BasePlayer player)
        {
            ...
            Interface.Oxide.LogDebug($"OnEntityReskinned test ... {skin.id} {skin.name}");
